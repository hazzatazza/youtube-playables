...
function loadScript(e, r) {
  if (r === "jszip") {
    return loadScriptFromPath("https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js");
  }
...
class Unarchiver {
  ...
  static open(r, l = null) {
    ...
    return new Promise((i, e) => {
      ...
      ((s.onload = async () => {
        let e = s.result;
        o._isGzip(e)
          ? (await o._loadFormat("gz"), (e = pako.inflate(e).buffer))
          : o._isXZ(e)
            ? (await o._loadFormat("xz"),
              (e = toXZ(new Uint8Array(e), 0, 0, 0, 2 ** 28).buffer))
            : o._isBZ2(e) &&
              (await o._loadFormat("bz2"),
  ...
  static _rarOpen(e, r, a) {
    return {
      ...
      password: r,
      rar_files: [
        { name: e, size: a.byteLength, type: "", content: new Uint8Array(a) },
      ],
    };
  }
  ...
  static _tarOpen(e, r, a) {
    return { file_name: e, array_buffer: a, password: r };
  }
      ...
      return {
        ...
        read: () =>
          new Promise((e, r) => {
            var a;
            n
              ? ((a = tarGetEntryData(t, s.array_buffer)),
                e(new File([a.buffer], i)))
              : e(null);
          }),
      };
    });
  ...
  static _checkHeader(r, e, a = 0, t = null) {
    ...
    for (let e = 0; e < r.length; ++e) if (n[e] != r[e]) return !1;
    return !0;
  }
}
